...
void login(void)
{
    ...
    while(i<3)
    {
        ...
        {
            system("cls");
            printf("_____ __   _ _______  _____   ______  ______ _______ _______ _______\n");
            printf("  |   | \\  | |       |     | |_____/ |_____/ |______ |          |   \n");
            printf("__|__ |  \\_| |_____  |_____| |    \\_ |    \\_ |______ |_____     |  \n");
            printf("_______  ______ __   __      _______  ______ _______ _____ __   _   \n");
            printf("   |    |_____/   \\_/        |_____| |  ____ |_____|   |   | \\  | \n");
            printf("   |    |    \\_    |         |     | |_____| |     | __|__ |  \\_| \n\n\n\n\n");
            i++;
        }
